...
class WalletCopyResearchConfig:
    ...
    ml_min_category_labeled_buys: int = int(os.getenv("WALLET_COPY_RESEARCH_ML_MIN_CATEGORY_LABELED_BUYS", "500"))
    ml_min_categories_at_floor: int = int(os.getenv("WALLET_COPY_RESEARCH_ML_MIN_CATEGORIES_AT_FLOOR", "5"))
    ml_max_top_category_share: float = float(os.getenv("WALLET_COPY_RESEARCH_ML_MAX_TOP_CATEGORY_SHARE", "0.55"))
    ml_min_wallet_labeled_buys: int = int(os.getenv("WALLET_COPY_RESEARCH_ML_MIN_WALLET_LABELED_BUYS", "25"))
    ml_min_wallets_at_floor: int = int(os.getenv("WALLET_COPY_RESEARCH_ML_MIN_WALLETS_AT_FLOOR", "35"))
    ml_max_top_wallet_share: float = float(os.getenv("WALLET_COPY_RESEARCH_ML_MAX_TOP_WALLET_SHARE", "0.15"))
    ml_min_unique_labeled_markets: int = int(os.getenv("WALLET_COPY_RESEARCH_ML_MIN_UNIQUE_LABELED_MARKETS", "500"))
    ml_max_top_market_share: float = float(os.getenv("WALLET_COPY_RESEARCH_ML_MAX_TOP_MARKET_SHARE", "0.05"))
    ml_min_resolution_labeled_buys: int = int(os.getenv("WALLET_COPY_RESEARCH_ML_MIN_RESOLUTION_LABELED_BUYS", "8000"))
    ml_min_wallet_sell_labeled_buys: int = int(os.getenv("WALLET_COPY_RESEARCH_ML_MIN_WALLET_SELL_LABELED_BUYS", "1000"))
